...
function p.getEnemyFlat(name)
    ...
    dst["level1"] = raw.maxHp1 or raw.atk1 or raw.def1 or raw.magicResistance1 or raw.baseAttackTime1 or raw.moveSpeed1 or raw.massLevel1 or raw.rangeRadiu1 or ""
    -- 数组
